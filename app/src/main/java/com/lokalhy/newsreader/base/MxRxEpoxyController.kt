package com.lokalhy.newsreader.base
...
/**
 * For use with [BaseMvRxFragment.epoxyController].
 *
...
fun <A : BaseMvRxViewModel<B>, B : MvRxState,
    ...
    > BaseMvRxFragment.simpleController(
    viewModel1: A,
    viewModel2: C,
    viewModel3: E,
    viewModel4: G,
    ...
    withState(viewModel1, viewModel2, viewModel3, viewModel4) { state1, state2, state3, state4 ->
        buildModels(state1, state2, state3, state4)
    }
}
